...
const statusLabels: Record<string, string> = {
  ...
  moving: "整理中", moved: "已整理", conflict: "名称冲突", filtered: "无文件符合过滤条件", failed: "失败", cancelled: "已取消",
};
